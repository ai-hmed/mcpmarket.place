...
export const metadata: Metadata = {
  ...
  description:
    "Explore comprehensive guides, tutorials, and resources about Model Content Protocol servers and deployment strategies",
};
  ...
  const resourceCategories = [
    {
      ...
      description:
        "Learn how to deploy and manage MCP servers across different cloud providers.",
    ...
    },
    {
      ...
      description:
        "Optimize your MCP servers for maximum performance and efficiency.",
    ...
    },
    {
      ...
      description:
        "Connect your MCP servers to various database systems for data persistence.",
    ...
    },
    {
      ...
      slug: "security",
      description:
        "Secure your MCP servers and protect your data with industry best practices.",
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white dark:from-blue-950 dark:to-background py-16 border-b border-border">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Comprehensive guides, tutorials, and resources for Model Content
            Protocol servers and deployment
          </p>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap gap-2">
            {popularKeywords.map((keyword, index) => (
              <Link
                key={index}
                href={`/resources/${keyword.keyword.replace(/\s+/g, "-")}`}
              >
                <Badge
                  variant="outline"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {resourceCategories.map((category, index) => (
            <div
              key={index}
              className="border border-border rounded-lg p-6 bg-card hover:shadow-md transition-all"
            >
